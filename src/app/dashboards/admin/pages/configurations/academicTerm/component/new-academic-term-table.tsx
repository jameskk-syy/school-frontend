...
export function AcademicTermTable({ data, onEdit, onDelete, purpose }: AcademicTermTableProps) {
  const [sorting, setSorting] = React.useState<SortingState>([])
  const [currentPage, setCurrentPage] = React.useState(1)
  const pageSize = 5

  console.log("AcademicTermTable data:", data)
  ...
  const columns: ColumnDef<AcademicTerm>[] = [
    ...
    { accessorKey: "term_name", header: "Term Name" },
    { accessorKey: "term_start_date", header: "Term start Date" },
    { accessorKey: "term_end_date", header: "Term end Date" },
    {
      accessorKey: "actions",
      header: "Actions",
      cell: ({ row }) => {
