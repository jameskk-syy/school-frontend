...
export function StudentCategoryTable({ data, onEdit, onDelete, purpose }: StudentCategoryTableProps) {
  const [sorting, setSorting] = React.useState<SortingState>([])
  const [currentPage, setCurrentPage] = React.useState(1)
  const pageSize = 5

  console.log("StudentCategoryTable data:", data)

  const columns: ColumnDef<StudentCategory>[] = [
    {
      accessorKey: "name",
      header: "ID",
